...
export default function UsersMenagment() {
  ...
  useEffect(() => {
    setLoader(true);
    fetch(`http://localhost:5000/admin/clients?token=d29611be-3431-11ee-b3e9-14dda9d4a5f0`, {
      credentials: 'include',
    }).then(res => res.json())
      .then((data) => {
...
const handleBusiness = (client) => {
    ...
    fetch(`http://localhost:5000/admin/clients/${client.id}?token=d29611be-3431-11ee-b3e9-14dda9d4a5f0`, {
      credentials: 'include',
      method: 'PUT',
  ...
  const handleDelete = (clientID)=> {
    ...
    fetch(`http://localhost:5000/admin/clients/${clientID}?token=d29611be-3431-11ee-b3e9-14dda9d4a5f0`, {
   credentials: 'include',
   method: 'DELETE',
})
.then(() => {
